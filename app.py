...
async def subscribe_push(data: dict, authorization: str = Header(None)):
    ...
    try:
        ...
        # Check if already exists (by student_id for simplicity, ideally by endpoint)
        # For simplicity in this schema, we use student_id as unique constraint.
        # This means one device per student. 
        # TODO: IF we want multi-device, we need schema change. For now, upsert.
